...
import context
from atm.atm import ATMPriorNetworkStudent
...
def main(args):
    ...
    atm = ATMPriorNetworkStudent(network_architecture=None,
    ...
    np.savetxt(os.path.join(args.output_dir, 'logits.txt'), test_logits_arr)
